...
const SModal = DialogPrimitive.Root;
const SModalTrigger = DialogPrimitive.Trigger;
const SModalPortal = DialogPrimitive.Portal;
const SModalClose = DialogPrimitive.Close;

const SModalOverlay = React.forwardRef<
...
SModalOverlay.displayName = DialogPrimitive.Overlay.displayName;
...
SModalContent.displayName = DialogPrimitive.Content.displayName;
...
SModalTitle.displayName = DialogPrimitive.Title.displayName;
...
SModalDescription.displayName = DialogPrimitive.Description.displayName;
...
function SModalSimple({
  ...
  return (
    <SModal open={open} onOpenChange={onOpenChange}>
      <SModalContent>
        {(title || description) && (
          <SModalHeader>
            {title && <SModalTitle>{title}</SModalTitle>}
            {description && <SModalDescription>{description}</SModalDescription>}
          </SModalHeader>
        )}
        {children}
